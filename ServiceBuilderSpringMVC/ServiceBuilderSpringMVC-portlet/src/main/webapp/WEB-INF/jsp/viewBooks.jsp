    ...
    <c:if test="${not empty books}">
        <table border="1">
            ...
            <c:forEach var="book" items="${books}">
                <tr id="<portlet:namespace/>${book.isbn}row">
                    <% if (!book_name) {
                    %>
                    <td valign="top">
                        <portlet:actionURL name="getBook" var="getBookURL">
                            <portlet:param name="isbn" value="${book.isbn}"></portlet:param>
                        </portlet:actionURL>
                    ...
                    <td valign="top">
                        <a
                            ...
                            "><b>Edit</b>
                            /
                            <a  href="#" onclick="<portlet:namespace/>Delete('${book.isbn}');return false;">Remove</a>
                    </td>
                    <% } %>
                    </a>
                    </td>
