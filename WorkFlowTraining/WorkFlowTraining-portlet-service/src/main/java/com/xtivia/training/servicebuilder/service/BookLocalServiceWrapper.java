...
public class BookLocalServiceWrapper implements BookLocalService,
    ...
    */
    ...
    public com.xtivia.training.servicebuilder.model.Book updateStatus(
        ...
        throws com.liferay.portal.kernel.exception.PortalException,
            com.liferay.portal.kernel.exception.SystemException {
        return _bookLocalService.updateStatus(userId, resourcePrimKey, status,
            serviceContext);
    }
    ...
    public com.liferay.portal.kernel.audit.AuditMessage buildAuditMessage(
        ...
        return _bookLocalService.buildAuditMessage(eventType, className,
            classPK, attributes);
    }
